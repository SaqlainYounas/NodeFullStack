...
/* ROUTES */
app.use("/dashboard", dashboardRoutes_1.default); //localhost:3001/dashboard
app.use("/products", productsRoute_1.default); //localhost:3001/products
app.use("/users", userRoutes_1.default); //localhost:3001/users
